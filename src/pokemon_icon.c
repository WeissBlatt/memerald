...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_ALOLAN_SANDSHREW] = gMonIcon_AlolanSandshrew,
    [SPECIES_ALOLAN_SANDSLASH] = gMonIcon_AlolanSandslash,
    [SPECIES_ALOLAN_VULPIX] = gMonIcon_AlolanVulpix,
    [SPECIES_ALOLAN_NINETALES] = gMonIcon_AlolanNinetales,
    [SPECIES_ALOLAN_DIGLETT] = gMonIcon_AlolanDiglett,
    [SPECIES_ALOLAN_DUGTRIO] = gMonIcon_AlolanDugtrio,
    [SPECIES_ALOLAN_MEOWTH] = gMonIcon_AlolanMeowth,
    [SPECIES_ALOLAN_PERSIAN] = gMonIcon_AlolanPersian,
    [SPECIES_ALOLAN_GEODUDE] = gMonIcon_AlolanGeodude,
    [SPECIES_ALOLAN_GRAVELER] = gMonIcon_AlolanGraveler,
    [SPECIES_ALOLAN_GOLEM] = gMonIcon_AlolanGolem,
    [SPECIES_ALOLAN_GRIMER] = gMonIcon_AlolanGrimer,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_ALOLAN_SANDSHREW] = 0,
    [SPECIES_ALOLAN_SANDSLASH] = 0,
    [SPECIES_ALOLAN_VULPIX] = 2,
    [SPECIES_ALOLAN_NINETALES] = 2,
    [SPECIES_ALOLAN_DIGLETT] = 2,
    [SPECIES_ALOLAN_DUGTRIO] = 2,
    [SPECIES_ALOLAN_MEOWTH] = 2,
    [SPECIES_ALOLAN_PERSIAN] = 2,
    [SPECIES_ALOLAN_GEODUDE] = 2,
    [SPECIES_ALOLAN_GRAVELER] = 2,
    [SPECIES_ALOLAN_GOLEM] = 2,
    [SPECIES_ALOLAN_GRIMER] = 1,
    [SPECIES_ALOLAN_MUK] = 0,
    [SPECIES_ALOLAN_EXEGGUTOR] = 1,
    [SPECIES_ALOLAN_MAROWAK] = 1,
    [SPECIES_SHAYMIN_SKY] = 1,
    [SPECIES_GIRATINA_ORIGIN] = 0,
    [SPECIES_DARMANITAN_ZEN] = 0,
